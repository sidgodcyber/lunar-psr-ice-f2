# Deliverable 3 — Landing Site Proposal
...
maximum annual illumination anywhere within rover range is **29%**
(the well-lit 40–50% rim lies >15 km away). The ">70%" hard constraint is therefore
**relaxed to > 22%** (≈44% of the near-pole
...
## Feasible Area
- Total feasible landing area (slope<10 & illum>22% & outside PSR & <15 km): **9.91 km²**
- Number of distinct candidate sites (≥5 pad-centres): **159**

## Decision Matrix (top 3)
| Site | Peak illum (%) | Dist F2 (km) | Mean slope (°) | Pad area (m²) | Weighted score | Lat/Lon | Earth-LOS |
|---|---|---|---|---|---|---|---|
| A | 29.3 | 14.6 | 5.1 | 618400 | 0.537 | -87.87°S, 82.66°E | yes |
| B | 28.3 | 14.6 | 7.5 | 28500 | 0.426 | -87.87°S, 82.15°E | yes |
| C | 26.9 | 14.7 | 5.2 | 22050 | 0.402 | -87.79°S, 88.69°E | yes |

Weights: illumination 0.35, proximity 0.30, slope 0.25, pad area 0.10.

## Selected Landing Site — Site A
- **Coordinates: -87.87°S, 82.66°E** (stereographic 63998, 8242 m)
- Peak illumination: **29%** annual (≈59% of near-pole max)
- Distance to F2: **14.6 km**
- Mean slope: **5.1°**  |  Earth-LOS (high ground): yes
...
- Bearing from Site A to F2: **81°**
- Corridor length: 14.6 km
- PSR boundary crossed ~5.7 km from landing (within LM7 extent).
